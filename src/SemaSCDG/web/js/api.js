...
system.api = (function() {
  ...
  */
  ...
  TODO Wip
  */
  this.reset_exploration = async () => {
    console.log('Start a new exploration!')
    this.waitTree(true)
    const res = await eel.new_exploration()()
    this.newExploration()
  }
  /*
  */
