import sys
import angr
import angr.concretization_strategies
import json
import time
import pickle
import claripy
...
class AngrWrapper(object):
    def __init__(self, project, address_to_block, smgr=None, symbols=None, pickle_state=None, starting_state=None, concretize_addresses=False):
        ...
        self.smgr             = smgr              # simulation manager
        self.stb              = None              # symbolic tree builder
    ...
    def filter_fun(self, avoid_blocks, avoid_edges):
        ...
        def f(state):
            ...
            try:
                ...
                bye = 0  # because parent may have been pruned by toolchain
                return 'active'
        return f
